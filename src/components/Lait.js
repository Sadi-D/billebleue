      ...
      <View style={styles.infoProduct}>
          ...
          <View
            ...
            <View style={styles.productDescription}>
              ...
              <View>
                <Text style={styles.productTitle}> Lait de vache - 1L</Text>
            ...
            <View
              ...
              <View>
                ...
                <Text style={styles.label}>n21.073.07</Text>
          ...
          <View style={styles.elevage}>
            ...
            <Text>- Nom de l'élevage: La Ferme de Monique</Text>
            <Text>- Type d'élevage: Petit exploitation</Text>
            <Text>- Commune: Vendée</Text>
            <Text>- Spécificité de l'exploitation: Agriculture Biologique</Text>
          </View>

          <View style={styles.animal}>
            <TouchableOpacity>
              <Text style={{fontSize: 20}}>Informations Produit</Text>
            </TouchableOpacity>
            <Text>- Type de lait - Lait cru</Text>
            <Text>- Transformaton: Ferment lactique</Text>
          </View>
        </ScrollView>
      </View>
    );
